...
public class SachAdminAdapter extends RecyclerView.Adapter<SachAdminAdapter.MyViewHolder> {

    private Context context;
    public ArrayList<Sach> sachList;
    CallBack sachCall;

    public SachAdminAdapter(Context context, ArrayList<Sach> SachList,CallBack SachCall) {
